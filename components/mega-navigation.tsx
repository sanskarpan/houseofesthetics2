  ...
  return (
    <header
      className={`fixed top-0 left-0 w-full z-50 transition-all duration-300 ease-in-out ${
        isScrolled 
          ? "bg-white/[0.7] backdrop-blur-md border-b border-gray-200/50 shadow-md" // 80% opaque white, backdrop blur, semi-transparent border, shadow
          : "bg-transparent border-b border-transparent" // Fully transparent
      }`}
      ref={dropdownRef}
    >
        ...
        <div className="md:hidden fixed inset-0 top-0 bg-white z-40 flex flex-col justify-center items-center pt-16 sm:pt-20"> {/* Full screen opaque white for mobile menu */}
          <nav className="text-center">
            <ul className="space-y-8">
              <li>
                <Link // Changed to Link for direct navigation example
                  href="/collections"
