  ...
  return (
    <header
      className={`fixed top-0 left-0 w-full z-50 transition-all duration-300 ease-in-out ${
        isScrolled
          ? "bg-white border-b border-gray-200 shadow-md" // Solid white opaque background on scroll
          : "bg-transparent backdrop-blur-sm border-b border-transparent" // Translucent (transparent with blur) initially
      }`}
      ref={dropdownRef}
    >
